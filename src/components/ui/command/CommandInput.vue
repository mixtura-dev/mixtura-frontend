...
<template>
  <div data-slot="command-input-wrapper" class="flex h-9 items-center gap-2 border-b px-3">
    ...
    <ListboxFilter
      ...
      :class="
        cn(
          'placeholder:text-muted-foreground flex h-9 w-full rounded-md bg-transparent py-1 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
          props.class,
        )
      "
    />
