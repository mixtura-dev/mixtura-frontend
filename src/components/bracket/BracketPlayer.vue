<template>
    <div class="participant" :title="displayName" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave"
...
const setHoveredParticipant = inject<(participantId: Id | null) => void>(SetHoveredParticipantKey, () => { })
