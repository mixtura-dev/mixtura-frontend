                        ...
                        <CommandList>
                            ...
                            <CommandGroup>
                                <CommandItem v-for="status in statuses" :key="status.value" :value="status.value"
                                    ...
                                    <Check v-show="selectedStatus?.value === status.value"
                            ...
                            <CommandGroup>
                                <CommandItem value="" asChild>
                                    <RouterLink to="/workspace" class="text-sm text-muted-foreground"
                                        @click="open = false">
                                        All workspaces
                                    </RouterLink>
                                </CommandItem>
...
const statuses: Status[] = [
    { value: 'backlog', label: 'asdasdsadadssdasdssdasdasdsadasdasasdasdasdasdasdasdadsadsadsasdadsadsads' },
