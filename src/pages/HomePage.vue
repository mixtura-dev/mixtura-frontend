<template>
  <section class="flex flex-row min-h-full">
    <div class="max-w-[1200px] w-full ml-auto p-4">
      <div ref="screenshotRef" class="grid  w-full h-fit grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-5">
        <div class="team-container bg-background flex flex-col gap-2 p-4 border-2 border-dashed rounded-lg min-w-3xs">
